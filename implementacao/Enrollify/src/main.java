...
public class Main {
    ...
    private static void carregarSistema() {
        ...
        if (universidade.getSecretarias().isEmpty()) {
            ...
            universidade.getSecretarias().add(secretaria);
        } else {
            secretaria = universidade.getSecretarias().get(0);
        }
    }
    ...
    private static void fazerLogin() {
        ...
        for (Secretaria s : universidade.getSecretarias()) {
    ...
    private static void adicionarDisciplinaAoCurriculo() {
        ...
        secretaria.adicionarDisciplinaAoCurso(disciplina, curso);
    }
